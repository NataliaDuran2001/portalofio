...
const availability = [
  { type: "Proyectos Freelance", status: "Disponible", color: "bg-green-500" },
  { type: "Consultoría Técnica", status: "Disponible", color: "bg-blue-500" },
  { type: "Mentoring", status: "Limitado", color: "bg-yellow-500" },
  { type: "Colaboraciones", status: "Abierta", color: "bg-purple-500" }
];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              ...
              ¡Me encantaría escuchar sobre tu idea y cómo puedo ayudarte!
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
                  ...
                  <div className="space-y-4">
                    {contactInfo.map((item, index) => (
                      <a
                        key={index}
                        href={item.link}
                        target={item.title === "LinkedIn" || item.title === "Ubicación" ? "_blank" : undefined}
                        rel={item.title === "LinkedIn" || item.title === "Ubicación" ? "noopener noreferrer" : undefined}
                        className="flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50 transition-colors group"
                      >
                        <div className={`w-10 h-10 bg-gradient-to-br ${item.gradient} rounded-lg flex items-center justify-center shadow-md group-hover:scale-110 transition-transform`}>
            ...
            <div className="lg:col-span-2">
              <Card className="border-0 shadow-xl">
                <CardHeader>
                  <h3 className="text-xl font-bold text-gray-900">Envíame un mensaje</h3>
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button
                      type="submit"
                      size="lg"
                      className="w-full bg-gradient-to-r from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 text-white shadow-lg hover:shadow-xl transition-all"
                    >
          ...
          <div className="text-center mt-16 p-8 bg-gradient-to-r from-blue-500 to-pink-500 rounded-2xl text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                ...
                asChild
              >
                <a href="https://www.linkedin.com/in/natalia-duran-oliva/" target="_blank" rel="noopener noreferrer">
