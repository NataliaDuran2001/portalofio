...
const projects = [
  {
    ...
    description: "Plataforma completa de microservicios para gestión de programas de lealtad con arquitectura orientada a eventos.",
  ...
  },
  {
    ...
    description: "Sistema crítico de cumplimiento normativo con precisión del 99% para detección y prevención de lavado de dinero.",
  ...
  },
  {
    ...
    description: "Servicio de integración completo con SAP Business One para optimización de procesos de despacho y almacén.",
  ...
  },
  {
    ...
    description: "Aplicación móvil que digitalizó completamente el proceso de toma de pedidos, integrándose con sistemas ERP.",
    image: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=500&h=300&fit=crop",
    achievements: [
      "100% digitalización de procesos",
      "80% aumento en eficiencia",
  ...
  },
  {
    ...
    description: "Diseño e implementación de arquitectura de microservicios para servicios bancarios core con alta disponibilidad.",
  ...
  },
  {
    ...
    description: "Sistema de gestión de seguros implementado con arquitectura hexagonal y principios de clean code.",
    image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=500&h=300&fit=crop",
    achievements: [
      "Arquitectura hexagonal",
      "Clean code implementation",
      "Productos de seguros unipersonales"
    ],
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="relative overflow-hidden">
                  ...
                  <div className={`absolute top-4 left-4 w-12 h-12 bg-gradient-to-br ${project.gradient} rounded-full flex items-center justify-center shadow-lg`}>
                ...
                <CardContent>
                  ...
                  <div className="flex gap-3">
                    <Button
                      variant="outline"
                      size="sm"
                      className="flex-1 border-blue-200 hover:bg-blue-50 hover:border-blue-300 transition-colors"
                    >
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      className="flex-1 border-pink-200 hover:bg-pink-50 hover:border-pink-300 transition-colors"
                    >
          ...
          <div className="text-center mt-16">
            ...
            <Button
              size="lg"
              className="bg-gradient-to-r from-blue-500 to-pink-500 hover:from-blue-600 hover:to-pink-600 text-white shadow-lg hover:shadow-xl transition-all"
              onClick={() => {
